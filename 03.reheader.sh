...
bcftools view -h /path/to/sequence.file.noChrXY.vcf.gz > /path/to/header.txt

#obtain the header from the hail output vcf
bcftools view -h /path/to/sequence.file.GTflt.AB.noChrXY.vcf.gz > /path/to/postHailHeader.txt
...
bcftools reheader -h /path/to/postHailHeader.txt /path/to/sequence.file.GTflt.AB.noChrXY.vcf.gz | \
  bgzip > /path/to/sequence.file.rehead.GTflt.AB.noChrXY.vcf.gz
tabix -p vcf /path/to/sequence.file.rehead.GTflt.AB.noChrXY.vcf.gz
