...
hl.import_vcf('/path/to/sequence.file.noChrXY.vcf.gz', min_partitions=4, reference_genome='GRCh38', force_bgz=True).write('/scratch/richards/guillaume.butler-laporte/WGS/hailFiles/hail.full.noChrXY.mt', overwrite=True)

mtAll = hl.read_matrix_table('/scratch/richards/guillaume.butler-laporte/WGS/hailFiles/hail.full.noChrXY.mt')
...
hl.export_vcf(mtAll, '/path/to/sequence.file.GTflt.AB.noChrXY.vcf.gz')
