...
p_mean_variant_dp=hl.plot.histogram(mtAll.variant_qc.dp_stats.mean,legend='Variant Mean DP')
p_variant_hwe_p=hl.plot.histogram(mtAll.variant_qc.p_value_hwe,legend='Variant HWE P-values')
...
export_png(p_variant_hwe_p, filename="/scratch/richards/guillaume.butler-laporte/tmpSort/p_variant_hwe_p.png")
